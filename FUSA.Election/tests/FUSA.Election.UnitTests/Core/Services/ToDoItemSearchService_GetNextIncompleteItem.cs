...
using FUSA.Election.Core.ProjectAggregate;
using FUSA.Election.Core.Services;
using FUSA.Election.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace FUSA.Election.UnitTests.Core.Services
{
