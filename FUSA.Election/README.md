...
To update the database use this command from the Web project folder (replace `FUSA.Election` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FUSA.Election.Infrastructure/FUSA.Election.Infrastructure.csproj -s FUSA.Election.Web.csproj
```
